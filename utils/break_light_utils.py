...
def break_light(dashPointer , image_np):
	...
	for i in range(len(contours)):
		...
		if radius >15:
			...
			indHull.append(i)
			cv2.putText(image_np,"Brake Light Detected",(170 ,80),  font, 1.2 , (0, 255, 255) , 2 , cv2.LINE_AA)
			cv2.putText(image_np,"Please Apply Brake.",                       (390 ,120), font, 1.2 , (0, 255, 255) , 2 , cv2.LINE_AA)
